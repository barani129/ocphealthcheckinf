...
func main() {
	...
	if clusterResourceNamespace == "" {
		var err error
		clusterResourceNamespace, err = getInClusterNamespacePath()
		if err != nil {
			if errors.Is(err, errorNotInCluster) {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "355df924.spark.co.nz",
...
var errorNotInCluster = errors.New("not running in cluster")

func getInClusterNamespacePath() (string, error) {
